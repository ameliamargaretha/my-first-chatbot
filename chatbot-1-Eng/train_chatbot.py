...
# create a model with 3 layers. First layer consists of 128 neurons, second layer consists of 64 neurons and the third one consists of number of neurons, equal to number of intents to predict output intent with softmax
